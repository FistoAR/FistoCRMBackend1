...
export function usePageTitle() {
  ...
  const titles = {
    ...
    "/admin/clientsData": "Client's Data",
    "/clientsData": "Client's Data",
    "/admin/followup": "Followups & Meetings",
    "/followup": "Followups & Meetings",
    "/admin/marketingLeeds": "Marketing Leeds",
    "/admin/project": "Project",
    "/admin/hr/employeeDetails": "Employee Details",
    "/admin/hr/addDesignation": "Add Designation",
    "/admin/hr/request": "Request",
    "/admin/hr/salaryCalculation": "Salary Calculation",
    "/admin/hr/interviewSchedules": "Interview Schedules",
    "/admin/hr/quotes": "Quotes",
    "/admin/hr/maid": "Maid",
    "/admin/report": "Report",
